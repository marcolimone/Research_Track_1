...
def main():
  ...
  while(1):
   ...
   if d_golden<d_th_golden  :                                       #"""control of the distance beetween robot and closest detected golden token"""
   ...
   elif d_silver < d_th_silver:                        # """if the robot is close enough to the token, we try grab it"""
       print("Found it!")
